...
public class LookUpTableV5 implements LUTInterface {
...
//        initialiseLUT();
    ...
    void initEpsilon(int totalRounds){
        ...
        exploreRate = (-0.9/4000) * totalRounds + 0.9;
//        exploreRate = -0.000225 * rounds + 0.9;
    ...
    public int getAction(int headingCos, int enemyDistance, int headingSin, int xPos, int yPos,  int enemyBearingCos, int enemyBearingSin){
        ...
        for (int i = 0; i < numActions; i++ ){
            Visits[headingCos][enemyDistance][headingSin][xPos][yPos][i] += 1;
...
//            System.out.println("Greedy policy\n");
    ...
    public int bestAction(int headingCos, int enemyDistance, int headingSin, int xPos, int yPos, int enemyBearingCos, int enemyBearingSin){
        ...
        //find state vector
        double[] actionColumn = Table[headingCos][enemyDistance][headingSin][xPos][yPos];
...
//        System.out.println("privious Q: " + prevQValue + "\n");
        if (onPolicy) { //on policy
            double Q = (Table[headingCos][enemyDistance][headingSin][xPos][yPos][actionIndex]);
...
//            System.out.println("current Q: " + QCurrent + "\n");
            ...
            double max = MaxQ(headingCos, enemyDistance, headingSin, xPos, yPos, enemyBearingCos, enemyBearingSin);
            double max2 = MaxQ(headingCos, enemyDistance, headingSin, xPos, yPos, enemyBearingCos, enemyBearingSin);
            QCurrent = prevQValue + learnRate *  (rewards + gamma * max - prevQValue);

        }
        Table[headingCos][enemyDistance][headingSin][xPos][yPos][actionIndex] = QCurrent;
