...
public class MainRobotV3 extends AdvancedRobot {
    //look up table object


    public static LookUpTableV3 lut = new LookUpTableV3();
...
//            System.out.println("Enemy Distanc: " + quantizedEnemyDistance);
            ...
            int quantizedEnemyBearingCos = lut.quantizeHeading(Math.cos(enemyBearingDegrees));
            int quantizedEnemyBearingSin = lut.quantizeHeading(Math.sin(enemyBearingDegrees));


            int quantizedHeadingCos = lut.quantizeHeading(Math.cos(heading));
            int quantizedHeadingSin = lut.quantizeHeading(Math.sin(heading));
